...
public class ReverseInteger {
    ...
    public static void main(String[] args) {
        ...
        while (input != 0) {
            //variable to store ramainder value
            Integer remainder = input % 10;
            //multiple previous reverse value by 10 , add remainder to it and save it back in reverse variable
